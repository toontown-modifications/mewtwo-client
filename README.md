...
[Panda3D SDK for Windows (Python 3.8, x86_64)](https://drive.google.com/file/d/19PQC4qdBTZ4GvBC4LeBTD-MQ_wlh2--0/view?usp=sharing)
...
If you use Linux, or are interested in building Panda3D yourself, head on over to [our Panda3D fork](https://github.com/toontown-modifications/panda) and read the "Building Panda3D" section on the README file there.
...
Be sure to wait till the servers have finished booting before starting the next.  If done correctly, you should be able to make your toon and play the game!  There is no support for Magic Words (commands) yet, [but it is currently in the works!](https://github.com/toontown-modifications/mewtwo-client/tree/magic-words)
