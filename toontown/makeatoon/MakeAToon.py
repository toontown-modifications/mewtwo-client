...
class MakeAToon(StateData.StateData):
    ...
    def load(self):
        ...
        self.roomDropActor.setBlend(frameBlend=base.settings.getSetting('smooth-frames', False))
        ...
        self.roomSquishActor.setBlend(frameBlend=base.settings.getSetting('smooth-frames', False))
        ...
        self.propSquishActor.setBlend(frameBlend=base.settings.getSetting('smooth-frames', False))
        ...
        self.spotlightActor.setBlend(frameBlend=base.settings.getSetting('smooth-frames', False))
